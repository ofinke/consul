...
class CommandProcessor:
    ...
    def register_default_commands(self) -> None:
        ...
        self.register_command("db", self.cmd_db_view, desc="Print 5 lates conversations from db.")
    ...
    def cmd_db_view(self, _: list[str]) -> None:
        ...
        columns = ("ID", "Conversation ID", "First user message", "Flow")
        caption = "Latest 10 conversations stored in the history database. Showing first user message."
        self.io.display_table(columns, udata, cap=caption)
