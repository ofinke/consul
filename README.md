This project is **archived**! As there is more than enough agentic harnesses to choose from, there is no need to develop my own. From my experience, I would recommend [opencode](https://opencode.ai/).
